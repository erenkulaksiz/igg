...
function login(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var ig, _a, username, password, shouldLogin;
        var _this = this;
            ...
            switch (_b.label) {
                case 0:
                    ...
                    if (!username || !password)
                        return [2 /*return*/, res.status(400).json({ error: "Missing username or password" })];
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    return [4 /*yield*/, (0, cookie_1.saveCookie)(serialized, username)];
                                case 2:
                                    _a.sent();
                                    return [2 /*return*/];
                            }
                ...
                case 1:
                    shouldLogin = (_b.sent()).shouldLogin;
                    if (!shouldLogin) return [3 /*break*/, 3];
                    return [4 /*yield*/, (0, connect_1.default)(ig, { username: username, password: password }).catch(function (err) {
                            console.error(err);
