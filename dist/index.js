...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var loggedInUser, userFeed, myPostsFirstPage, myPostsSecondPage;
        ...
        switch (_a.label) {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                ...
                                (0, cookie_1.saveCookie)(serialized);
                                return [2 /*return*/];
                        }
                    });
                }); });
                return [4 /*yield*/, (0, cookie_1.cookie)(ig)];
            case 1:
                _a.sent();
                return [4 /*yield*/, (0, connect_1.default)(ig, credentials)];
            case 2:
            ...
            case 4:
                ...
                return [4 /*yield*/, ig.media.like({
                        mediaId: (0, lodash_1.sample)([myPostsFirstPage[0].id, myPostsSecondPage[0].id]) || "",
                        moduleInfo: {
                            module_name: "profile",
                            user_id: loggedInUser.pk,
                            username: loggedInUser.username,
                        },
                        d: (0, lodash_1.sample)([0, 1]) ? 1 : 0,
                    })];
            case 5:
                _a.sent();
                return [2 /*return*/];
